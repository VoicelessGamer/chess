...
/**
 * Retrieves the relevant move data for a Bishop piece at a given position on the board.
...
mod bishop_tests {
  ...
  /**
   * Testing the checking path is calculated correctly through the get_bishop_move_data function
   */
  #[test]
  fn test_check_path() {
    let board_config = config::BoardConfig {
