...
pub struct MoveData {
  ...
  pub attacks: Vec<Position>,               // TODO: This array will be a copy of valid_moves in most cases (maybe separate MD structs for pawn/king that have a MD field + special data) * All positions this piece has under attack
